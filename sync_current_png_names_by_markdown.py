...
SOURCE_ROOT = PROJECT_ROOT / "docs/user"

TARGET_ROOT = (
    PROJECT_ROOT
    / "i18n/de/docusaurus-plugin-content-docs/current/user"
)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Gleicht PNG-Dateinamen in der deutschen Current-"
            "Dokumentation an die Namen aus docs/user an."
        )
    )
    ...
    for source_document in source_documents:
        ...
        for source_ref, target_ref in zip(
            ...
            # Gewünschter Zielname existiert bereits.
            if (
                ...
                # Zielname existiert bereits und beide Dateien
