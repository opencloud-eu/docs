...
<img src={require("../../img/general/settings/logging/logging-button.png").default} alt="Logging Button" height="650"/>
...
<img src={require("../../img/general/settings/logging/logging-menu.png").default} alt="Logging Menu" height="650"/>
...
<img src={require("../../img/general/settings/logging/log-files-list.png").default} alt="Log files List" height="650"/>
