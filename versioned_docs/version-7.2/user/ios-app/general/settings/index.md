...
<img src={require("../.././img/general/settings/settings.png").default} alt="Settings" width="1920"/>
...
### [2. Search Settings](./search-settings.md)
...
### [4. Cellular Data Usage](./cellular-data-usage.md)

Here you can set whether the app can be used with cellular data or not.

### [5. Delete Unused Local Copies](./delete-unused-local-copies.md)
