...
<img src={require("../../img/general/settings/delete-unused-local-copies/delete unused local copies button.png").default} alt="Delete unused local copies Button" height="650"/>
...
<img src={require("../../img/general/settings/delete-unused-local-copies/delete unused local copies settings.png").default} alt="Delete unused local copies settings" height="650"/>
