...
- Open the context menu - By right-clicking - or by clicking on the three dots next to the file.

  <img src={require("./img/upload-download-unzip/download-options.png").default} alt="Download options" width="1920"/>

- Select “Download” from the menu or in the top bar.
...
If activated, you can unzip packed files in the cloud.
