...
title: Desktop Client for Windows
---
...
- [Installation](./installation.md)  
  Install the OpenCloud Desktop Client from the Microsoft Store.

- [Set up OpenCloud Desktop](./set-up.md)  
  Connect your OpenCloud account and complete the initial client configuration.

- [Synchronization Settings in Windows](./sync-settings.md)  
  Learn how the Windows Virtual File System (VFS) works, manage file availability, and configure synchronization behavior.
