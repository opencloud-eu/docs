...
|`OC_LDAP_LOOKUP_CACHE_TTL`<br/>`USERS_LDAP_LOOKUP_CACHE_TTL`| next |Duration|`The time to live for the in-memory cache of LDAP lookups. This cache is used to reduce the number of LDAP queries for user and group lookups.`|`"10s"`|
