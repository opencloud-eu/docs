...
- Click "Continue"
  ...
  <img src={require(".././img/linux/set-up/set-up-enter-url.png").default} alt="Enter URL" width="400"/>
...
- Alternatively, copy the provided URL and paste it into your browser manually
  ...
  <img src={require(".././img/linux/set-up/set-up-login.png").default} alt="Open browser to login" width="400"/>
...
- Click "Login"
  ...
  <img src={require(".././img/linux/set-up/set-up-user-password.png").default} alt="Enter credentials" width="400"/>

## Grant Access

- Accept the access request to link your account with OpenCloud Desktop.

  <img src={require(".././img/linux/set-up/set-up-accept-access.png").default} alt="Grand access" width="400"/>
...
- Change the local download directory where your files will be stored.
  ...
  <img src={require(".././img/linux/set-up/set-up-advanced-configuration.png").default} alt="Finalize setup" width="400"/>

Once you're ready, click Done to complete the setup.

<img src={require(".././img/linux/set-up/set-up-all-set.png").default} alt="All set" width="400"/>
