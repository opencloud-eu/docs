...
- If you've already set up an account and want to add another one, tap the "+" icon located at the bottom left corner of the screen.
  ...
  <img src={require(".././img/general/set-up/add-additional-account.png").default} alt="Add additional account" height="400"/>
...
- Grant the app permission to access your user information and maintain continuous access
  ...
  <img src={require(".././img/general/set-up/enter-credentials.png").default} alt="Enter Opencloud credentials" height="400"/>
  <img src={require(".././img/general/set-up/grant-access.png").default} alt="Grant access" height="400"/>
...
- Optionally, assign a custom display name to your account  
  ...
  <img src={require(".././img/general/set-up/custom-name.png").default} alt="Enter custom name" height="400"/>
