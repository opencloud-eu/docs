...
| Container (recommended)               | <ul><li>Docker Compose or Podman</li><li>Kubernetes Helm Charts (available with a [professional or premium subscription](https://opencloud.eu/en/product/service-and-support) ) </li></ul>                                                                                                                                             |
