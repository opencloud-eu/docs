...
| Container (recommended)               | <ul><li>Docker Compose or Podman</li><li>Kubernetes Helm Charts (available with a [enterprise subscription](https://opencloud.eu/en/produkt/service-and-support) ) </li></ul>                                                                                                                                                          |
