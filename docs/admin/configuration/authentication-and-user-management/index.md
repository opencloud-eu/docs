...
For detailed configuration and setup instructions, see the [Keycloak Shared User Directory](authentication-and-user-management/keycloak#shared-user-directory-mode) guide.
...
For detailed configuration and setup instructions, see the [Keycloak with Autoprovisioning](authentication-and-user-management/keycloak#autoprovisioning-mode) guide.
