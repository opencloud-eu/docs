...
- Die Suchleiste befindet sich oben in der Web-Oberfläche.
  <img src={require("./img/search/searchbar.png").default} alt="Suchleiste" width="1920"/>
...
- Wählen Sie, ob Sie in allen Dateien oder nur im aktuellen Ordner suchen möchten.
  <img src={require("./img/search/drop-down-menu-searchbar.png").default} alt="Auswahl, wo gesucht werden soll" width="500"/>
- Die Suchfunktion sucht sowohl nach Dateinamen als auch nach dem Inhalt der Dateien, um relevante Ergebnisse anzuzeigen.
  <img src={require("./img/search/search-example.png").default} alt="Suchbeispiel" width="500"/>
