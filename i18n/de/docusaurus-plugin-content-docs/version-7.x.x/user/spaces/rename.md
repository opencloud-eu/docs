...
- Klicken Sie im Space-Überblick auf das Drei-Punkte-Menü oder machen Sie einen Rechtsklick auf den Space und wählen Sie „Umbenennen“.
  ...
  <img src={require("./img/rename/umbenennen-button.png").default} alt="Umbenennen" width="1920"/>

- Geben Sie den neuen Namen für den Space ein und bestätigen Sie.

  <img src={require("./img/rename/umbenennen-popup.png").default} alt="Bestätigen" width="1920"/>

- Jetzt wurde Ihr Space umbenannt.
  <img src={require("./img/rename/space-mit-neuem-namen.png").default} alt="Umbenannter Space" width="1920"/>
