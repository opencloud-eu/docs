...
- Wählen Sie die Option Quota ändern in der Top-Bar oder im Drei-Punkte-Menü
  <img src={require("./img/quota/top-bar.png").default} alt="Context-Menu" width="1920"/>
...
- Wählen Sie eine Standardgröße (z.B. 5 GB) aus dem Dropdown-Menü.
  ...
  <img src={require("./img/quota/context-menu.png").default} alt="Select-quota" width="500"/>

- Geben Sie eine individuelle Speichergröße ein.

      <img src={require("./img/quota/select.png").default} alt="Enter-quota" width="500"/>
