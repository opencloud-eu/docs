...
- Alternativ können Sie auch auf das Drei-Punkte-Menü in der Spaceübersicht klicken und Deaktivieren aus dem Menü wählen.
  ...
  <img src={require("./img/enable-disable/disable-three-dots.png").default} alt="Admin general" width="1920"/>
...
- Bestätigen Sie die Auswahl, indem Sie auf Aktivieren klicken.  
  <img src={require("./img/enable-disable/confirm-enable.png").default} alt="Admin general" width="500"/>
