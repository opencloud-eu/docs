...
<img src={require("../../img/general/settings/logging/logging-button.png").default} alt="Schaltfläche Protokollierung" height="650"/>
...
<img src={require("../../img/general/settings/logging/logging-menu.png").default} alt="Menü Protokollierung" height="650"/>
...
<img src={require("../../img/general/settings/logging/log-files-list.png").default} alt="Liste der Protokolldateien" height="650"/>
