...
- Klicken Sie in der oberen Aktionsleiste auf „Deaktivieren“ oder öffnen Sie das Kontextmenü.
  ...
  <img src={require("./img/enable-disable/disable-space-overview.png").default} alt="Space in der Übersicht deaktivieren" width="1920"/>

- Bestätigen Sie die Deaktivierung.

  <img src={require("./img/enable-disable/disable-confirm.png").default} alt="Deaktivierung bestätigen" width="1920"/>

- Der Space ist jetzt deaktiviert.

  <img src={require("./img/enable-disable/disabled-space.png").default} alt="Deaktivierter Space" width="1920"/>
  :::note
...
- Nachdem der Space deaktiviert wurde, ersetzt die Option „Aktivieren“ nun „Deaktivieren“.
  ...
  <img src={require("./img/enable-disable/enable.png").default} alt="Admin general" width="1920"/>
...
- Wenn der Space nicht sichtbar ist, kann der Filter „Deaktivierte Spaces anzeigen“ aktiviert sein.
  ...
  <img src={require("./img/enable-disable/include-disabled.png").default} alt="Deaktivierte Spaces anzeigen" width="1920"/>

- Aktivieren Sie den Filter, damit der Space angezeigt wird und wieder aktiviert werden kann.

  <img src={require("./img/enable-disable/disable-included.png").default} alt="Space wieder verfügbar" width="1920"/>
