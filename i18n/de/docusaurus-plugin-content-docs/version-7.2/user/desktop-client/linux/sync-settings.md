...
<img src={require(".././img/linux/sync-settings/sync-settings-three-dot.png").default} alt="Account-Spaces-Menü" width="400"/>

## Synchronisationsoptionen

<img src={require(".././img/linux/sync-settings/sync-settings-menu.png").default} alt="Synchronisationsoptionen-Menü" width="400"/>
...
<img src={require(".././img/linux/sync-settings/sync-settings-choose-what-to-sync.png").default} alt="Zu synchronisierende Dateien auswählen" width="400"/>
