...
<img src={require(".././img/common-functionality/conflict-files/conflict-file.png").default} alt="Konfliktdateien im Explorer" width="1920"/>
...
<img src={require(".././img/common-functionality/conflict-files/conflict-info.png").default} alt="Benachrichtigung zu Dateikonflikten im Desktop-Client" width="500"/>
