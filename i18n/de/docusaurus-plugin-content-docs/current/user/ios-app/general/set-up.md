...
<img src={require("../img/general/set-up/start-setup.png").default} alt="Einrichtung starten" height="400"/>
<img src={require("../img/general/set-up/add-additional-account.png").default} alt="Zusätzlichen Account hinzufügen" height="400"/>
...
<img src={require("../img/general/set-up/enter-server-url.png").default} alt="Server-URL eingeben" height="400"/>
...
<img src={require("../img/general/set-up/open-login-page.png").default} alt="Login-Seite öffnen" height="400"/>
<img src={require("../img/general/set-up/continue-sign-in.png").default} alt="Anmeldung fortsetzen" height="400"/>
...
<img src={require("../img/general/set-up/enter-credentials.png").default} alt="Zugangsdaten eingeben" height="400"/>
<img src={require("../img/general/set-up/grant-access.png").default} alt="Zugriff gewähren" height="400"/>
...
<img src={require("../img/general/set-up/custom-name.png").default} alt="Benutzerdefinierter Name" height="400"/>

- Dein OpenCloud Account ist jetzt vollständig eingerichtet und einsatzbereit!

<img src={require("../img/general/set-up/account-set-up.png").default} alt="OpenCloud Account ist eingerichtet" height="400"/>
