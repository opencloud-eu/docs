...
- Um ein zusätzliches Konto einzurichten, tippe auf die Schaltfläche „Konten verwalten“ und wähle „Konto hinzufügen“.
  ...
  <img src={require("../img/general/set-up/additional-account.png").default} alt="Zusätzliches Konto" height="400"/>
...
<img src={require("../img/general/set-up/account-set-up.png").default} alt="Konto ist eingerichtet" height="400"/>
